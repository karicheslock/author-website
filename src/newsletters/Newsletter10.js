        ...
        <div className="w-4/5 mx-auto">
            ...
            <div className="flex flex-col border-4 border-amber-900 bg-amber-50 p-4">
                ...
                <p className="mb-4 leading-7">
                    Welcome to the tenth edition of the newsletter for C.K. Brandywine Publishing.  After a brief hiatus, I&apos;m finally back and writing up a storm!  For this reason, I&apos;m going to take a slightly different approach to this newsletter.  I haven&apos;t had time for 
                    much reading lately, so I&apos;m going to tell you what I&apos;ve been writing and then skip straight to the writing prompt.  I&apos;ll be getting back to reading again soon, though.  And when I do, I&apos;ll tell you all about it.  But without further ado, let me
                    tell you about everything I&apos;ve been working on.
                </p>
                ...
                <p className="mb-8 leading-7">Click <a href="https://www.amazon.com/dp/B0BXHHHY67" target="_blank" rel="noreferrer" className="text-red-800 font-bold hover:text-green-900">here</a> to purchase the novel.</p>
                ...
                <p className="mb-8 leading-7">Click <a href="https://www.amazon.com/dp/B0BXQ3T5F6" target="_blank" rel="noreferrer" className="text-red-800 font-bold hover:text-green-900">here</a> to purchase the novel.</p>
                ...
                <p className="mb-8 leading-7">Click <a href="https://www.amazon.com/dp/B0BXJRHM2D" target="_blank" rel="noreferrer" className="text-red-800 font-bold hover:text-green-900">here</a> to purchase the novel.</p>
                ...
                <p className="mb-8 leading-7">Click <a href="https://www.amazon.com/dp/B0BXPQFFHJ" target="_blank" rel="noreferrer" className="text-red-800 font-bold hover:text-green-900">here</a> to purchase the novel.</p>
                ...
                <p className="mb-8 leading-7">Click <a href="https://www.amazon.com/dp/B0BZN626H2" target="_blank" rel="noreferrer" className="text-red-800 font-bold hover:text-green-900">here</a> to purchase the novel.</p>
                ...
                <div className="border-2 border-dashed bg-gray-50 p-4">
                    <p className="mb-4 mt-4 leading-7">I woke up in a sweat from the latest round of my recurring dream.  Or is it a nightmare at this point?</p>
                    <br />
                    <p className="mb-4 mt-4 leading-7">Your story continues from here…</p>
                </div>
                <p className="mb-4 mt-4 leading-7">And that&apos;s it!  Thank you for reading the tenth edition of my newsletter.  I hope to hear from you soon!</p>
                <p className="mt-4 leading-7">It&apos;s okay to hide in the shadows as long as you can still see the light,</p>
                <p>C.K.</p>
                <p>March 30, 2023</p>
            </div>
        </div>
