        ...
        <div className="w-4/5 mx-auto">
            ...
            <div className="flex flex-col border-4 border-amber-900 bg-amber-50 p-4">
                ...
                <p className="mb-4 leading-7">
                    Welcome to the ninth edition of the newsletter for C.K. Brandywine Publishing.  I want to start out by saying how happy I am that we have finally reached my favorite time of year!  Halloween!! 🎃👻💀⚰️ My house is decorated and I'm staying up late every night 
                    eating bite size candy bars and watching horror movies.  Of course, I&apos;m supposed to be saving the candy bars for trick-or-treaters, but I&apos;m sure there will be some left by the time the big day rolls around.  At least, I hope there will be 🤞🤞🤞.
                </p>
