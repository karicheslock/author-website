...
function Navbar() {
  return (
    <div className="container flex h-24 items-center bg-green-900 font-mono border-l-8 border-r-8 border-b-8 border-amber-900 min-w-900">
        <p className="mx-auto text-center underline underline-offset-8 decoration-amber-900 decoration-double decoration-4 text-amber-50 font-bold tracking-wide text-3xl whitespace-nowrap">The Works of C.K. Brandywine</p>
