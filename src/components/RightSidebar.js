...
function RightSidebar() {
  return (
    <div className='flex flex-col w-72 bg-amber-50 h-auto border-l-8 border-r-8 border-solid border-amber-900 font-mono pl-1 pr-1'>
      <div className='mt-4 mb-4'><a href="https://mern-reading-journal-app-kari.herokuapp.com/" target="_blank" rel="noreferrer" className='border-2 border-amber-600 rounded px-2 py-1 hover:px-4 hover:py-2 text-green-900 font-bold'>Free Book Journal</a></div>
