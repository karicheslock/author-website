          ...
          <div className="flex justify-between h-screen">
            ...
            <div className="bg-green-900 w-full">
                <div className="bg-amber-50 font-mono m-8 p-2 border-2 rounded border-amber-900">
                    <p className="mb-4">C.K. Brandywine lives in San Diego with her husband, her son and two rescue dogs, Bruce and MJ.  However, she grew up in the south and finds inspiration for many of her stories in classic southern gothic horror.  She is a small part Native American 
                    ...
                    <p>When she is not writing, she enjoys cooking, reading, crocheting and playing video games.  She is also a hobby web developer.  Other inspiration for her writing comes from the video games that she plays, mainly MMO style fantasy games.  She often comments 
